...
import { BookMarked, House, Info, LibraryBig, Phone, PhoneCall } from 'lucide-react';
                ...
                <div className="flex items-center justify-between h-24">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <Button
                                onClick={() => window.open("https://app.testonline.vn/vi/home?scope=672794105b4a9e627f0cb75a")}
            ...
            {open && (
                <div className="absolute top-24 left-0 h-[830px] w-full bg-white shadow-md border-t border-gray-200 z-20">
                    <ul className="flex flex-col space-y-10 py-10 px-5">
                        ...
                        <li className='font-bold flex flex-row items-center gap-3'>
                            <Info size={20} />
                            <a href={`/ve-chung-toi`} className="text-gray-700 hover:text-black">
                                Về chúng tôi
                            </a>
                        </li>
                        <li className='font-bold flex flex-row items-center gap-3'>
                        ...
                        <li className='font-bold flex flex-row items-center gap-3'>
                            <BookMarked size={20} />
                            <a href={`/tips`} className="text-gray-700 hover:text-black">
                                Tips IELTS
                            </a>
                        </li>
                        <li className='font-bold flex flex-row items-center gap-3'>
